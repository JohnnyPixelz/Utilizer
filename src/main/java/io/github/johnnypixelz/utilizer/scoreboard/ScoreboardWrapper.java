...
public class ScoreboardWrapper {
    ...
    public ScoreboardWrapper(String title) {
        ...
        objective.setDisplayName(Colors.color(title));
     ...
     */
    public ScoreboardWrapper setTitle(String title) {
        objective.setDisplayName(Colors.color(title));
        return this;
    }
     ...
     */
    public ScoreboardWrapper addLine(String line) {
     ...
     */
    public ScoreboardWrapper addBlankSpace() {
        addLine(" ");
        return this;
    }
     ...
     */
    public ScoreboardWrapper setLine(int index, String line) {
