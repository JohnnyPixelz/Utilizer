...
public class OldSQL {
    ...
    public static OldSQL connect(@Nonnull DatabaseCredentials credentials) {
        ...
        return new OldSQL(credentials, dialect);
    }

    public static OldSQL connect(@Nonnull DatabaseCredentials credentials, @Nonnull SQLDialect dialect) {
        return new OldSQL(credentials, dialect);
    }
    ...
    private OldSQL(@Nonnull DatabaseCredentials credentials, @Nonnull SQLDialect dialect) {
